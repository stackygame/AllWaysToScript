...
print("DSNM TERMINAL WE DONT NEED BASH")
...
while True:
    ...
    if syantx.startswith("puttext "):
        custom_print(syantx[7:])
    elif syantx.startswith("create "):
        parts = syantx.split()
        if len(parts) == 3:
    ...
    elif syantx == "/subtractnum":
        num1 = float(custom_input("Enter first number: "))
        num2 = float(custom_input("Enter second number: "))
        custom_print(f"Result: {num1 - num2}")
    elif syantx == "/multiplynum":
        num1 = float(custom_input("Enter first number: "))
        num2 = float(custom_input("Enter second number: "))
        custom_print(f"Result: {num1 * num2}")
    elif syantx == "/dividenum":
        num1 = float(custom_input("Enter first number: "))
        num2 = float(custom_input("Enter second number: "))
        if num2 != 0:
            custom_print(f"Result: {num1 / num2}")
    ...
    elif syantx.startswith("foritem "):
